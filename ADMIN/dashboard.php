...
<body>
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu top">
            ...
            <li>
                <a href="Student_bookings.php" class="brand">
            ...
            <section class="stats-container">
                ...
                <div class="stat-box grid-container">
                    ...
                    <div>
                        <p> 
                            <?php 
                                $admin_sql = "SELECT * from vehicles";
                                $admin_result = mysqli_query($conn,$admin_sql);
                ...
                <div class="stat-box grid-container users">
                    ...
                    <div>
                        <p> 
                            <?php 
                                $admin_sql = "SELECT * from drivercredentials";
                                $admin_result = mysqli_query($conn,$admin_sql);
                ...
                <div class="stat-box grid-container">
                    ...
                    <div>
                        ...
                        <h2>Bookings</h2>
                        <h2>
                        <a href="Student_bookings" style="text-decoration:none;" class="action" >
                            <button id="generateBtn" >
                                Generate
                            </button>
                        </a>
